...
<head>
    ...
    <link rel="stylesheet" href="../../CSS/newsletter_gestion_css/inscription_nl.css">
    ...
    <style>
        #form-banner{position:fixed; top:0px; right:20px; padding:14px 18px; border-radius:6px; box-shadow:0 4px 12px rgba(0,0,0,.18); z-index:9999; color:#fff; font-weight:600; height: 10px; display:flex; align-items:center; gap:12px;}
        #form-banner.success{background:#28a745;}
        #form-banner.fail{background:#dc3545;}
        #form-banner .close_alert{cursor:pointer; background:transparent; border:none; color:inherit; font-size:18px;}
        /* petite animation d'apparition */
        #form-banner{opacity:0; transform:translateY(-6px); transition:opacity .4s, transform .4s;}
    ...
    <ul class="icon-list"> 
        ...
        <div id="formulaire">
            ...
            <div id="newsLetter">
                ...
                <img src="../../images/newsLetter.png" alt="photo d'une news_letter" style="width: 250px; height: 180px; ">
            </div>
            <hr>
            <span id="form_contact">Formulaire d'inscription</span>
                <?php if (isset($_POST['submit'])) : ?>
                    <div id="form-banner" class="<?php echo $res_execution ? 'success' : 'fail'; ?>">
                        <div style="margin-top: 20px;">
                            <?php if ($res_execution) : ?>
                                <strong>Succès !</strong> Vous vous êtes abonné avec succès.
                            <?php else : ?>
                                <strong>Erreur !</strong> Erreur lors de l'abonnement.
                                <?php /* Uncomment to debug: echo isset($insert_error) ? '<div style="font-weight:400;margin-top:6px;">'.htmlspecialchars($insert_error).'</div>' : ''; */ ?>
                            <?php endif; ?>
                        </div>
                        <button class="close_alert" aria-label="Fermer" onclick="closeBanner()">&times;</button>
                    </div>
                <?php endif ?>
            <p>
            ...
            <input id="submit" type="submit" name="submit" value ="S'abonner">
             </form>
        </div>
        ...
        <div class="aside"> 
          ...
          <video controls width="300px" height="300px" autoplay loop muted poster="../../video/miniature.png">
            ...
            <div class="bloc_nouveautes" style=" text-align: center; background-color: rgb(249, 246, 246);">
                ...
                ?>
                <div id="conn_inscrip">
                    <a id="conn" href="./connexion.php">Se connecter</a>
                    <a id="insc" href="./inscription_nl.php">S'abonner</a>
                </div>
        </div>
    </div>
    </main>
...
<script>
    ...
    window.addEventListener('DOMContentLoaded', function(){
        ...
        // disparaître après 4s (4000ms)
        setTimeout(function(){
            b.style.transition = 'opacity 0.6s, transform 0.6s';
            b.style.opacity = '0';
