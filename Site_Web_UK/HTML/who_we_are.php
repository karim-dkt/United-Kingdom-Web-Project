...
<br><br>
    ...
    <section class="top-row">
      <div class="top-image">
        ...
        <img src="../images/karim_pic.png" alt="Photo de karim">
      </div>

      <div class="top-text">
            <h1>Karim Diakité</h1>
            <h2>Etudiant en Licence d'Informatique</h2>
            <p>Passionné par la cybersécurité, je souhaite acquérir des bases solides et développer progressivement
                 les compétences nécessaires pour devenir un expert capable de protéger efficacement les données et 
                 les systèmes face aux menaces numériques. Les échecs sont l’une de mes passions, car ils stimulent 
                 mon sens de l’analyse, de la stratégie et de la planification, des qualités que j’applique également 
                 dans mon approche de l’informatique. Je suis motivé à apprendre, expérimenter et progresser chaque jour,
                  avec l’objectif de poursuivre mes études dans cette voie et de devenir, à terme, un véritable protecteur
                   des données dans un monde de plus en plus connecté.</p>
       </div>
    </section>

    <section class="bottom">
        <div class="top-text">
            <h1>Barry Elhadj Aliou</h1>
            <h2>Etudiant en Licence d'Informatique</h2>
            <p>
                En quête d'une formation complète en <b class="specif">Software engenering</b>
                et des études plus poussées en <b class="specif">Frontend developpement</b>, étant admiratif de 
                belles créations et d'outils optimisés, j'espère acquerir les outils, compétences et expériences nécessaires 
                pour dévélopper des logiciels qui se démarqueront par leurs performances. Bref développer les logiciels incontournables du quotidien.
            </p>
       </div>
      <div class="right">
        <img src="../images/elhadj_pic.jpg" alt="Image de Elhadj Aliou">
      </div>
    </section>
</div>
