...
<br><br>
    ...
    <?php 
        if ($article) {
            ...
            echo "<p>Publié le : " . $article['date_publication'] . "</p>" ;
            echo "</div>";
            echo "<br><div class='resume' style='font-size: larger; font-weight: bolder;'>" . $article['resumee'] . "</div><br><br>";
            echo "<div class='full_content'>" . $article['contenu'] . "</div>";
        } else {
            echo "<p>Article non trouvé.</p>";
        }
    } else {
        echo "<p>ID d'article manquant ou invalide.</p>";
    }
    ?>
</div>
            ...
            <div class="bloc_nouveautes" style=" text-align: center; background-color: rgb(249, 246, 246);">
                ...
                <?php
                    ...
                    while($news=$rows->fetch()) {
                      ...
                      echo "<div class='news_div'style='font-size: 70%; width: 300px;border: 2px solid rgb(114, 111, 111);  border-radius: 10px ; box-shadow: none;'>";
                        echo "<div><p >".$news["date_publication"]."</p>" ;
                        echo "<p >".$news["titre"]."</p></div>";
                        // Link to view the full article ; on passe le news_id en parametre dans l'url
