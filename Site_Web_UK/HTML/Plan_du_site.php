...
<br><br>
    ...
    <ul class="icon-list"> 
        <li><a href="carte.php">Carte UK</a></li>
           ...
           <div class="plansite" id="plansite">
            <h1>PLAN DE SITE</h1>
               <div class="accueil_liste">
                  <h2>Accueil - coups de coeur</h2>
                  <ul>
                       <li><a href="../HTML/camden_lock.php">Camden Lock</a></li>
                       <li><a href="../HTML/chausse_des_geants.php">Chaussée des géants</a></li>
                       <li><a href="../HTML/cathedral_manchester.php">Cathédrale Manchester</a></li>
                       <li><a href="../HTML/saint_paul.php">Saint Paul</a></li>
                       <li><a href="../HTML/regent_street.php">Regent Street</a></li>
                       <li><a href="../HTML/carnouailles.php">Les Carnouailles</a></li>
                       <li><a href="../HTML/london_eye.php">London Eye</a></li>
                  </ul>
               </div>
               <div class="ville_liste">
                <h2>Villes</h2>
                <ul>
                       <li><a href="../HTML/london_city.php">Londres</a></li>
                       <li><a href="../HTML/edimbourg_city.php">Edimbourg</a></li>
                       <li><a href="../HTML/belfast_city.php">Belfast</a></li>
                  </ul>
               </div>
               <div class="monument_liste">
                <h2>Monuments</h2>
                 <ul>
                       <li><a href="../HTML/Bigben.php">Big Ben et le palais de Westminster</a></li>
                       <li><a href="../HTML/british_museum.php">Musée britannique</a></li>
                       <li><a href="../HTML/shard.php">Shard</a></li>
                  </ul>
               </div>
               <div class="carte">
                <h2>Carte</h2>
                <ul>
                      <li><a href="../HTML/carte_uk.php">Carte du Royaume-Uni</a></li>
                  </ul>
               </div>
               <div class="link_liste">
                <h2>À visiter</h2>
                <ul>
                      <li><a href="https://www.visitbritain.com">Visit Britain</a></li>
                      <li><a href="https://www.britishmuseum.org">Site du musée</a></li>
