...
<br><br>
    ...
    <section class="top-row">
      <div class="top-image">
        ...
        <img src="../images/tower_bridge.png" alt="Image de présentation">
      </div>

      <div class="top-text">
        <h1>Le Symbole Majestueux de Londres</h1>
        <h2>Pont, architecture, patrimoine</h2>
        <p>
            Le Tower Bridge est l’un des monuments les plus emblématiques de Londres. Avec ses deux grandes tours néogothiques, son pont-levis et sa silhouette unique au-dessus de la Tamise,
            il est devenu un symbole de l’ingéniosité britannique.
            Situé à proximité de la Tour de Londres, il attire chaque année des millions de visiteurs séduits par son mélange d’histoire, de technologie et d’élégance architecturale.
        </p>
    </section>
    ...
    <section class="middle-text">
      <p>
        Le Tower Bridge se distingue tout d’abord par son rôle historique. Construit à la fin du XIXᵉ siècle pour faciliter la navigation sur la Tamise tout en permettant le passage des voitures et des piétons,
        il reste aujourd’hui encore un ouvrage fonctionnel. Son système de levage, autrefois entièrement mécanique, impressionne toujours autant lorsqu’il s’ouvre pour laisser passer les bateaux.
        À l’intérieur des tours, un parcours muséal permet de découvrir les coulisses du pont : son histoire, ses moteurs d’origine et les différentes étapes de sa construction. Les passerelles supérieures,
        équipées de sections en verre, offrent une vue spectaculaire sur la ville, révélant la skyline londonienne sous un angle unique.
        Au-delà de son aspect technique, le Tower Bridge est aussi un lieu de promenade prisé. De jour, ses pierres claires ressortent sur le bleu de la Tamise. De nuit, ses éclairages rendent le monument 
        encore plus impressionnant, en faisant un point de repère visuel majeur au cœur de Londres.
    </p>
    </section>
    ...
    <section class="bottom">
      <div class="left">
            <p>
                Le Tower Bridge incarne ainsi le lien entre tradition et modernité. À la fois infrastructure vivante, espace culturel et œuvre architecturale, il représente l’âme de Londres : une ville en mouvement,
                fière de son histoire et tournée vers l’avenir. Un passage incontournable pour comprendre le charme unique de la capitale britannique.
            </p>
     </div>

      <div class="right">
        <img src="../images/tower_bridge_day.png" alt="Image secondaire">
      </div>
    </section>
</div>
