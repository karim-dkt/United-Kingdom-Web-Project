...
<head>
    <meta charset="UTF-8">
    <title>Chaussée des Géants</title>
...
<br><br>
    ...
    <section class="top-row">
      <div class="top-image">
        ...
        <img src="../images/cdg2.jpg" alt="Image de présentation">
      </div>

      <div class="top-text">
        <h1>'Chaussée des Géants' Le Trésor Naturel Mystique d’Irlande du Nord</h1>
        <h2>Géologie, légende, nature</h2>
        <p>
            La Chaussée des Géants, merveille géologique et légendaire, s’étend majestueusement sur la côte d’Antrim en Irlande du Nord. Composée de quelque 40 000 colonnes de basalte parfaitement juxtaposées, elle forme un pavage naturel qui plonge dans la mer, incarnant à la fois la puissance de la nature et l’imagination mythique.
        </p>
    </section>
    ...
    <section class="middle-text">
      <p>
            Ce site se distingue par son origine volcanique vieille de 50 à 60 millions d’années, lorsque des coulées de lave se sont solidifiées et fracturées en colonnes polygonales aux formes régulières. Ces formations, uniques et spectaculaires, sont inscrites au patrimoine mondial de l’UNESCO.
            Selon la légende, un géant irlandais nommé Finn McCool aurait construit cette chaussée pour défier un rival écossais, le géant Benandonner. 
            National Trust

            Les paysages rocheux, les falaises abruptes et les sentiers côtiers permettent aux visiteurs de contempler un décor à la fois sauvage et harmonieux, où la science — par l’étude du basalte et du volcanisme — et le mythe se rejoignent.     </p>
    </section>
    ...
    <section class="bottom">
      <div class="left">
            <p>
                Un voyage à la Chaussée des Géants, c’est se connecter à l’histoire profonde de la Terre tout en s’immergeant dans un univers mythologique. Entre promenades sur les rochers, panoramas maritimes et récits ancestraux, c’est un lieu qui rappelle que le passé naturel et le merveilleux peuvent coexister.
            </p>
     </div>

      <div class="right">
        <img src="../images/chaussee_geants.png" alt="Image secondaire">
      </div>
    </section>
</div>
