...
if (isset($_POST['submit'])) {
    ...
    // Identifiants admin (à remplacer plus tard par une base de données)
    $admin_user = "Karim";
    $admin_pass = "Diakite77";
...
<head>
    ...
    <link rel="stylesheet" href="../../CSS/newsletter_gestion_css/login_logout.css">
...
<br><br>
    ...
    <ul class="icon-list"> 
        ...
        <div id="formulaire">
            <div class="warning" style="width: 300px;  line-height: 30px; ">
                <br><br>
                <h2 id="adminSpace">Espace de connexion-Administrateur</h2>
                <h5 style="color: rgb(51, 51, 51);">Cet espace est reservé à l'administrateur du site <br>
                    Vous devez disposez des droits d'accès pour pouvoir vous y connecter.
                </h5>
            </div>
            
            <form action="" method = "post" style="background-color: none;  border-left: solid 2px ; border-image: linear-gradient(to bottom, red, blue) 1; height: 320px;"> <br>
                <h2 id="form_contact">Renseignez vos informations</h2> <br>
                ...
                <?php if ($verif===0 ) {
                   echo "<p style='color: red; font-style: italic;margin: 10px 30px ;'>Identifiants incorrects</p>"; }
                ?> 
                <input id="submit" type="submit" name="submit" value ="Connexion">
             </form>
             <h5 style="position: absolute; bottom:0px;left: 10px; color: #5d5c5c; line-height: 25px;">
                <hr>Si vous êtes l'administrateur de ce site web, vous disposez déjà d'un identifiant et d'un
                mot de passe qui vous permet d'avoir accès à la page d'alimentation et de modification de la news letter.
                Assurez vous de renseignez ces informations ! 
                <br>Si vous n'êtes pas l'administrateur de ce site, veillez explorer le site et profitez de votre droit de lecture
                de la news letter ! 
                <br>Vous pouvez consultez la page &nbsp; <a href="?">Plan du site</a> &nbsp; pour une navigation plus intuitive.
             </h5>
        </div>
        <div class="aside"> 
