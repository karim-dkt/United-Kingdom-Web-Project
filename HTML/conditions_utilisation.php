...
<head>
    ...
    <link rel="stylesheet" href="../CSS/conditions_utilisation.css"> 
    ...
    <div class="page">
        <section class="conditions-content">
            <div class="container">
                ...
                <p class="intro-text">
                    Bienvenue sur notre site. L'utilisation de ce site est soumise aux conditions suivantes.
                </p>

                <h2>1. Acceptation des Conditions</h2>
                <p>
                    L'accès et l'utilisation de ce site web sont subordonnés à l'acceptation des présentes Conditions Générales d'Utilisation. En naviguant sur ce site, vous reconnaissez avoir lu, compris et accepté ces conditions. Si vous n'acceptez pas ces termes, veuillez ne pas utiliser ce site.
                </p>

                <h2>2. Propriété Intellectuelle</h2>
                <p>
                    Tout le contenu de ce site (textes, images, vidéos, logos, code, etc.) est la propriété exclusive des auteurs (Elhadj Aliou Barry et Karim Diakité) ou de leurs concédants de licence, et est protégé par les lois françaises et internationales sur le droit d'auteur.
                </p>
                <ul>
                    <li>La reproduction ou l'utilisation, même partielle, sans autorisation écrite est strictement interdite.</li>
                    <li>Les images et vidéos utilisées sont soit libres de droits, soit utilisées sous licence, ou appartiennent aux auteurs.</li>
                </ul>
                
                <h2>3. Limitation de Responsabilité</h2>
                <p>
                    Les informations fournies sur ce site sont à titre informatif et peuvent contenir des inexactitudes ou des erreurs factuelles. Nous nous efforçons d'assurer l'exactitude des informations, mais nous ne pouvons garantir qu'elles sont complètes, précises et à jour en permanence.
                </p>
                <ul>
                    <li>Le site ne pourra être tenu responsable des dommages directs ou indirects résultant de l'utilisation du site ou de l'impossibilité d'y accéder.</li>
                    <li>Les liens externes vers d'autres sites web sont fournis uniquement pour votre commodité, et nous n'exerçons aucun contrôle sur leur contenu.</li>
                </ul>

                <h2>4. Abonnements (Newsletter)</h2>
                <p>
                    L'abonnement à notre newsletter est volontaire. Les données personnelles collectées dans ce cadre (adresse e-mail, nom) sont utilisées exclusivement pour l'envoi de la newsletter et ne seront pas partagées avec des tiers sans votre consentement explicite. Vous pouvez vous désabonner à tout moment via le lien inclus dans chaque e-mail.
                </p>
                
                <h2>5. Modification des Conditions</h2>
                <p>
                    Nous nous réservons le droit de modifier les présentes Conditions d'Utilisation à tout moment. Il est de votre responsabilité de les consulter régulièrement. Votre utilisation continue du site après la publication des modifications constitue votre acceptation de ces changements.
                </p>

                <h2>6. Droit Applicable</h2>
                <p>
                    Les présentes conditions sont régies par le droit applicable au lieu de résidence des auteurs du projet (à déterminer : ex: Droit français). Tout litige lié à l'utilisation du site sera soumis à la juridiction compétente.
                </p>

                <p class="date-mise-a-jour">
