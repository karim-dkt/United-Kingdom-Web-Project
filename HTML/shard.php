...
<head>
    <meta charset="UTF-8">
    <title>Le Royaume-Uni en images</title>
...
<br><br>
    ...
    <ul class="icon-list"> 
     ...
     <!-- HAUT : image à gauche, texte à droite -->
       <h1 style="text-align: center;">Le shard</h1><br>
    <section class="top-row">
      <div style="text-align: center;" class="top-image">
        <!-- Remplace "img1.jpg" par ton fichier -->
        <img src="../images/Monuments/shard/shard1.jpg" alt="Image de présentation">
      </div>
    ...
    <section class="middle-text">
        ...
        <div class="top-text">
        <h2 style="text-align: center;">La Modernité au Sommet de Londres</h2><br>
        <p>Dominant la rive sud de la Tamise, The Shard s’impose comme un point de repère contemporain dans le paysage londonien. 
            Sa silhouette effilée, visible depuis de nombreux quartiers de la ville, illustre la capacité de Londres à conjuguer mémoire urbaine et audace architecturale. 
            L’édifice participe aujourd’hui au récit visuel de la capitale, marquant la transition entre quartiers historiques et zones d’affaires modernes.
        </p>
        </div>

        <p>Inauguré en 2012, The Shard est l’un des symboles de la modernité à Londres. 
            Situé près du London Bridge, ce gratte-ciel emblématique domine la skyline londonienne avec ses lignes élancées et son architecture futuriste. 
            Conçu par l’architecte italien Renzo Piano, il incarne la volonté du Royaume-Uni de s’inscrire dans une dynamique contemporaine, tournée vers l’innovation, tout en s’intégrant dans un paysage urbain chargé d’histoire.
        </p> 
      <p>
       Avec ses 310 mètres de hauteur, The Shard est l’un des plus hauts bâtiments d’Europe occidentale. 
       Sa structure de verre, qui semble se fragmenter vers le ciel, lui donne l’apparence d’un gigantesque éclat de verre, d’où son nom (“shard” signifie “éclat”). 
       Le bâtiment accueille des bureaux, des restaurants, un hôtel de luxe, ainsi que des appartements privés, ce qui en fait un véritable espace de vie vertical au cœur de Londres.
      <p>
     L’une des principales attractions de The Shard est son belvédère panoramique, connu sous le nom de The View from The Shard. 
     Situé aux étages supérieurs, il offre une vue spectaculaire à 360° sur Londres : la Tamise, le Tower Bridge, le Saint Paul’s Cathedral, le London Eye et bien d’autres monuments sont visibles par temps dégagé. 
     Cette plateforme d’observation attire chaque année de nombreux visiteurs, venus découvrir la capitale britannique sous un angle unique.
      </p><br>
      <p>
      Au-delà de sa dimension touristique, The Shard est également un symbole de développement durable et de technologie. 
      Le bâtiment intègre des systèmes de gestion de l’énergie, une utilisation optimisée de la lumière naturelle et des matériaux modernes conçus pour réduire son impact environnemental. 
      Par son style, ses fonctions et son emplacement stratégique, The Shard représente le visage contemporain de Londres : une métropole à la fois historique et résolument tournée vers l’avenir.
       </p>
        <p>
        Par son caractère iconique, sa diversité fonctionnelle et sa présence dans le skyline londonien, The Shard représente le visage contemporain d’une métropole en mutation : un lieu où l’innovation architecturale rencontre la vie quotidienne, offrant aux visiteurs et aux Londoniens une expérience urbaine résolument moderne.
        </p>
    </section><br>
    <section>
