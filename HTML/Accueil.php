...
$req_pageAcc = "select news_id, date_publication, titre from news order by date_publication desc ;" ;
...
<br><br>
    ...
    <ul class="icon-list"> 
        ...
        <div>
            ...
            <div class="images">
                <a href="../HTML/camden_lock.php" target="_self"><img src="../images/camden1.png" alt= "camden lock" ></a>
                <a href="../HTML/chausse_des_geants.php" target="_self"><img src="../images/cdg2.jpg" alt="chaussé des geants" ></a>
                <a href="tower_bridge.php" target="_self"><img src="../images/tower_bridge.png" alt="le tower bridge" style="object-position: 40% 10% ;"></a>
                <a href="../HTML/cathedral_manchester.php" target="_self"><img src="../images/manchester_cathedral.png" alt="cathedral de manchester" ></a>
                <a href="../HTML/saint_paul.php" target="_parent"><img src="../images/saint_paul_night.png" alt="saint paul" ></a>
                <a href="../HTML/regent_street.php" target="_self"><img src="../images/regent street.png" alt="regent street england" style="object-position: 50% 70%;" ></a>
            </div>
    ...
    <div class="images_horizontaux">
                <a href="../HTML/carnouailles.php" target="_self"><img src="../images/Cornouailles4.jpg" alt="carnouilles"></a>
                <a href="../HTML/carnouailles.php" target="_self"><img src="../images/Cornouailles2.jpg" alt="carnouilles"></a>
                <a href="london_eye.php" target="_self"><img src="../images/vue_london_eye.png"  alt="London eye"></a>
            </div>
