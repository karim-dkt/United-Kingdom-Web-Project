...
<br><br>
    ...
    <section class="top-row">
      <div class="top-image">
        ...
        <img src="../images/camden1.png" alt="Image de présentation">
      </div>

      <div class="top-text">
        <h1>'Camden Lock' Le Marché Animé de Londres</h1>
        <h2>Commerce, culture, créativité</h2>
        <p>
            Camden Lock, lieu emblématique de la culture londonienne, s’anime au rythme de ses marchés, de ses canaux et de son ambiance unique. Avec ses étals colorés, ses artistes de rue et ses bâtiments industriels réaménagés, il incarne l’esprit créatif et éclectique de la ville, attirant chaque année des visiteurs fascinés par son atmosphère vivante et alternative.
        </p>
    </section>
    ...
    <section class="middle-text">
      <p>
        Camden Lock se distingue par son histoire et son caractère atypique. Installé au bord du Regent’s Canal, ce marché a émergé au XXᵉ siècle et s’est transformé en un centre culturel où artisanat, mode, musique et gastronomie se côtoient. Les bâtiments rénovés, les graffitis et les ponts pittoresques créent un décor vibrant, tandis que les boutiques indépendantes, food trucks et galeries artistiques offrent une expérience immersive. Le marché et les quais permettent aux visiteurs de découvrir un espace où créativité et communauté se rejoignent. Au-delà de son rôle commercial, Camden Lock accueille régulièrement des concerts, expositions et événements culturels, renforçant son importance dans la vie londonienne. Camden Lock illustre ainsi le lien entre tradition et modernité. À la fois lieu de commerce, espace culturel et quartier vivant, il représente l’âme alternative de Londres : un patrimoine urbain dynamique, témoin de la créativité et ouvert sur le présent.
     </p>
    </section>
    ...
    <section class="bottom">
      <div class="left">
            <p>
                 Un détour par Camden Lock offre un aperçu unique du Londres alternatif. Entre flânerie le long des canaux, dégustation de spécialités locales et découvertes artistiques, chaque visiteur peut ressentir l’énergie et l’originalité qui font la renommée de ce quartier. C’est un lieu où chaque coin de rue raconte une histoire, où la créativité est à chaque pas et où l’expérience londonienne prend toute sa dimension.
            </p>
     </div>

      <div class="right">
        <img src="../images/camden_lock_night.png" alt="Image secondaire">
      </div>
    </section>
</div>
