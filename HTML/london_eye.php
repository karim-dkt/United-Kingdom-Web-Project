...
<br><br>
    ...
    <section class="top-row">
      <div class="top-image">
        ...
        <img src="../images/vue_london_eye.png" alt="Image de présentation">
      </div>

      <div class="top-text">
        <h1>London Eye : La Roue Panoramique emblématique de Londres</h1>
        <h2>Monument, panorama, modernité</h2>
        <p>     
            Le London Eye, véritable icône du paysage londonien, domine majestueusement les rives de la Tamise. Avec sa silhouette élégante et moderne, cette grande roue attire chaque année des millions de visiteurs fascinés par la vue imprenable qu’elle offre sur la capitale britannique. Symbole de renouveau et de dynamisme, elle est devenue l’un des lieux les plus photographiés de Londres.
        </p>
    </section>
    ...
    <section class="middle-text">
      <p>
        Le London Eye se distingue par son architecture futuriste et son expérience immersive. Inaugurée en 2000 pour célébrer le passage au nouveau millénaire, la roue mesure 135 mètres de haut et propose des capsules entièrement vitrées permettant une visibilité panoramique à 360°. En son sommet, les visiteurs découvrent un tableau spectaculaire : Big Ben, Westminster, la Tamise, Buckingham Palace, la City… Londres apparaît sous un nouvel angle, dévoilant un mélange harmonieux d’histoire et de modernité. L’expérience se poursuit au fil de la rotation douce, qui dure environ 30 minutes, offrant un moment de contemplation unique au-dessus de la ville.
      </p>
    </section>
    ...
    <section class="bottom">
      <div class="left">
            <p>
                Bien plus qu’une attraction touristique, le London Eye est devenu un symbole culturel, accueillant événements, illuminations saisonnières et célébrations majeures comme le Nouvel An londonien. Par sa présence lumineuse et sa modernité assumée, il incarne l’esprit de la capitale : une ville ouverte, créative et en constante évolution. Une expérience incontournable pour comprendre Londres dans toute sa grandeur et son énergie.
            </p>
     </div>

      <div class="right">
        <img src="../images/London_eye_night.png" alt="Image secondaire">
      </div>
    </section>
</div>
