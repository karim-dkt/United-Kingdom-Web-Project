...
$req_news = "select news_id,date_publication, titre, resumee from news ;" ;
$news = $conn->query($req_news) ;
        ...
        <div class="centre_news">
            ...
            while($new=$news->fetch()) { 
                $count++ ;
                    ...
                    echo "<div class='titre_date' >"; 
                        echo "<p >".$new["titre"]."</p>"; 
                        echo "<p >".$new["date_publication"]."</p>" ; 
                        echo "</div>" ;

                        echo "<div class='titre_date' >"; 
                        echo "<p >".$new["resumee"]."</p>"  ;
                        echo "<a href=\"article.php?news_id=" . $new["news_id"] . "\" style='font-size:100%; color: blue;'>Lire la suite</a>";
                        echo "</div>" ;
                        
                    echo "</div>" ;
                if($count>=10) {
                    echo "<div class='news_div' style='text-align: center;'><strong>...</strong></div>" ;
                    break ;
                } } ?> 
        </div> 
        <div class="aside"> 
            ...
            <div class="bloc_nouveautes" style=" text-align: center; background-color: rgb(249, 246, 246);">
                ...
                <?php
                    ...
                    while($news=$rows->fetch()) {
                        ...
                        echo "<div class='news_div'style='display:flex; justify-content: space-between; align-items: center; font-size: 70%; width: 300px;border: 2px solid rgb(114, 111, 111);  border-radius: 10px ; box-shadow: none;'>";
                        echo "<div style='width: 290px;'><p >".$news["date_publication"]."</p>" ;
                        echo "<p >".$news["titre"]."</p></div>";
                        echo "<div><a href=\"article.php?news_id=" . $news["news_id"] . "\" style='font-size:100%; color: blue ;'>Cliquez pour voir l'article</a></div>";
