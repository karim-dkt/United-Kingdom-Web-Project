...
<br><br>
    ...
    <section class="top-row">
      <div class="top-image">
        ...
        <img src="../images/Cornouailles2.jpg" alt="Image de présentation">
      </div>

      <div class="top-text">
        <h1>Cornouailles : Le Joyau Celtique de la Côte Sud-Ouest Britannique</h1>
        <h2>Région, patrimoine, culture</h2>
        <p>
            Les Cornouailles, situées à l’extrémité sud-ouest de l’Angleterre, sont un trésor de traditions celtiques, de paysages sauvages et d’histoire maritime. Cette péninsule idyllique séduit chaque année des visiteurs grâce à sa combinaison unique de nature, de patrimoine et d’identité culturelle profonde.
        </p>
    </section>
    ...
    <section class="middle-text">
      <p>
        Les Cornouailles se distinguent par leur riche héritage culturel et leur forte identité régionale. Autrefois puissantes grâce à l’industrie minière du cuivre et de l’étain, elles ont forgé un passé industriel qui résonne encore aujourd’hui dans les musées et les sites historiques, comme la célèbre Poldark Mine. 
        Wikipédia
        Parallèlement, la tradition celtique y est bien vivante : danses, musique folk, festivals colorés comme le Lowender Peran et des célébrations en l’honneur de Saint Piran, saint patron des Cornouailles. 
        Wikipédia
        +2
        Wikipédia
        +2

        La langue cornique, presque éteinte, connaît un renouveau, et la région est reconnue pour son “Cornish Distinctiveness” — une volonté de préserver et valoriser ce patrimoine immatériel unique. 
        cornwall.gov.uk
        +1
        Architectoniquement, les Cornouailles offrent des villages typiques aux constructions en granit, des falaises découpées, des phares, et des sites extraordinaires comme le Minack Theatre, un théâtre en plein air sculpté dans la falaise. 
        VisitBritain.org

        Sur le plan artistique, la créativité locale est florissante : galeries, théâtres ou musiciens contribuent à une scène vivante qui mêle modernité et racines traditionnelles. 
        visitcornwall.com
        Côté gastronomie, la région est célèbre pour ses Cornish pasties (tourtes salées traditionnelles), sa “clotted cream” et d’autres spécialités locales typiques.
      </p>
    </section>

    <!-- BAS : gros texte à gauche, petit cadre-image à droite -->
    <section class="bottom">
      <div class="left">
            <p>
                Les Cornouailles incarnent ainsi le lien entre passé et présent : une terre de légendes celtiques, de paysages naturels grandioses et d’un esprit communautaire fort. Cette région est un témoignage vivant d’une culture qui a su perdurer et se renouveler, tout en restant profondément attachée à ses racines. Une destination incontournable pour comprendre l’âme celtique et maritime du Royaume‑Uni.
            </p>
     </div>

      <div class="right">
        <img src="../images/Cornouailles4.jpg" alt="Image secondaire">
      </div>
    </section>
</div>
        ...
        <div class="aside"> 
          ...
          <video controls width="300px" height="300px" autoplay loop muted poster="../video/miniature.png">
           ...
           <div class="bloc_nouveautes" style=" text-align: center; background-color: rgb(249, 246, 246); padding-bottom:20px;">
                <p style="font-size:120%;">Nouveautés</p>
            <?php
                    $numb_row = 0 ;
                    while($news=$rows->fetch()) {

                      echo "<div class='news_div' style='font-size: 70%; width: 310px;border: 2px solid rgb(114, 111, 111);  border-radius: 10px ; box-shadow: none; '>";
                        echo "<div style='width: 290px; height: 60px;'><p >".$news["date_publication"]."</p>" ;
                     ...
                     $numb_row += 1 ;
                        if ($numb_row >=2){
                            echo "<div style='border: 2px solid rgb(114, 111, 111); width:320px ; border-radius: 8px ; height: 40px; padding-top: 0px;'>" ;
