...
<head>
    <meta charset="UTF-8">
    <title>Manchester Cathedral</title>
...
<br><br>
    ...
    <section class="top-row">
      <div class="top-image">
        ...
        <img src="../images/manchester_cathedral.png" alt="Image de présentation">
      </div>

      <div class="top-text">
        <h1>Le Symbole Gothique de Manchester</h1>
        <h2>Édifice religieux, patrimoine, culture</h2>
        <p>
            La Cathédrale de Manchester est un joyau gothique niché au cœur de la ville. Avec ses voûtes élancées, ses vitraux colorés et son atmosphère de recueillement
            elle illustre parfaitement l’histoire religieuse et architecturale de Manchester, attirant chaque année de nombreux visiteurs fascinés par son élégance intemporelle.
        </p>
    </section>
    ...
    <section class="middle-text">
      <p>
       La Cathédrale se distingue d’abord par son architecture gothique remarquable. Construite sur plusieurs siècles, elle mélange harmonieusement pierres anciennes, vitraux et sculptures détaillées.
       À l’intérieur,la lumière traverse les vitraux et met en valeur les chapelles et les éléments sculptés, offrant un spectacle visuel unique. Son cloître et ses espaces ouverts permettent aux visiteurs
       de découvrir un lieu où histoire, spiritualité et culture se rejoignent.
       Au-delà de son aspect architectural, la cathédrale accueille régulièrement concerts et événements culturels, renforçant son rôle central dans la vie de la ville.
       La Cathédrale de Manchester incarne ainsi le lien entre tradition et vie contemporaine. À la fois lieu de culte, site historique et espace culturel, elle représente l’âme de la ville
       : un patrimoine vivant, témoin de l’histoire et ouvert sur le présent. Une visite incontournable pour comprendre la richesse culturelle et l’identité de Manchester.
    </p>
    </section>
    ...
    <section class="bottom">
      <div class="left">
            <p>La Cathédrale de Manchester incarne ainsi le lien entre tradition et vie contemporaine. À la fois lieu de culte, site historique et espace culturel, elle représente l’âme de la ville : un patrimoine vivant,
                témoin de l’histoire et ouvert sur le présent. Une visite incontournable pour comprendre la richesse culturelle et l’identité de Manchester.</p>
     </div>

      <div class="right">
        <img src="../images/manchester_cath_night.png" alt="Image secondaire">
      </div>
    </section>
</div>
