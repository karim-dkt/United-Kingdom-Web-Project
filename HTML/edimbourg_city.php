...
<head>
    <meta charset="UTF-8">
    <title>Découvrir Edimbourg</title>
...
<br><br>
    ...
    <section class="hero-london">
        <div class="hero-text">
            <h1>Découvrir Édimbourg</h1>
            <h2>Une capitale entre histoire, collines et légendes</h2>
            <p>
                Édimbourg, capitale de l’Écosse, est une ville au caractère unique, bâtie entre collines volcaniques, 
                ruelles médiévales et bâtiments néoclassiques. Elle mêle patrimoine historique, atmosphère mystérieuse 
                et vie culturelle dynamique tout au long de l’année.
            </p>
        </div>
        <div class="hero-image">
            <img src="../images/Villes/Edimbourg/edim1.jpeg" alt="Vue panoramique d’Édimbourg">
        </div>
    </section>
    ...
    <section class="london-grid">
        ...
        <article class="london-card">
            <h3>Ville médiévale et ville nouvelle</h3>
            <p>
                Édimbourg est organisée autour de deux ensembles classés au patrimoine mondial de l’UNESCO : 
                la Vieille Ville, avec ses ruelles étroites et son château dominant la colline, et la Nouvelle Ville, 
                aux avenues régulières et à l’architecture géorgienne élégante.
            </p>
        </article>

        <article class="london-card">
            <h3>Un château emblématique</h3>
            <p>
                Perché sur un ancien volcan, le château d’Édimbourg domine la ville et offre une vue imprenable sur les environs. 
                Il a joué un rôle central dans l’histoire de l’Écosse, abritant rois, reines et joyaux de la couronne écossaise.
            </p>
        </article>

        <article class="london-card">
            <h3>Culture, festivals et traditions</h3>
            <p>
                Édimbourg est connue pour ses festivals, notamment le Fringe et le Festival International, qui attirent des artistes 
                du monde entier. La ville reste aussi attachée à ses traditions, avec la musique écossaise, les kilts et les pubs chaleureux.
            </p>
        </article>
    ...
    <h2>À ne pas manquer lors d’une visite à Édimbourg</h2>

    <div class="highlight-row">
        <div class="highlight-image">
            <figure class="highlight-figure">
                <img src="../images/Villes/Edimbourg/chateau_edim.jpg" alt="Château d’Édimbourg">
                <figcaption>Vue emblématique du Château d’Édimbourg sur Castle Rock.</figcaption>
            </figure>
        </div>
        <div class="highlight-text">
            <h3>Le château d’Édimbourg</h3>
            <p>
    Perché au sommet du Castle Rock, le château d’Édimbourg domine la ville comme un témoin majestueux de l’histoire écossaise. 
    Site le plus visité du pays, il dévoile à la fois l’héritage militaire et royal de l’Écosse, des remparts imposants aux joyaux de la couronne. 
    Depuis ses tours et terrasses, le visiteur profite d’un panorama spectaculaire, embrassant la Vieille Ville, les collines environnantes et la mer au loin, 
    offrant une expérience où l’histoire et le paysage se fondent en un spectacle saisissant.
</p>

            <p class="highlight-tip">
                <strong>Astuce :</strong> Achetez vos billets en ligne à l'avance, surtout pendant la saison des festivals d'été, pour éviter de longues files d'attente.
            </p>
        </div>
    </div>
    ...
    <div class="highlight-row reverse">
        <div class="highlight-text">
            <h3>Le Royal Mile</h3>
            <p>
    Le Royal Mile, artère emblématique d’Édimbourg, s’étire du château jusqu’au palais de Holyrood. 
    Bordée de boutiques pittoresques, de musées fascinants, d’églises anciennes et de petites ruelles étroites appelées “closes”, 
    elle offre un véritable voyage à travers le temps. Chaque pas révèle l’histoire de la Vieille Ville, ses légendes, 
    son architecture médiévale et l’âme vibrante de la capitale écossaise.
</p>

            <p class="highlight-tip">
                <strong>Astuce :</strong> Explorez les "closes" (ruelles étroites) pour découvrir des cours cachées et des histoires fascinantes de la Vieille Ville.
            </p>
        </div>
        <div class="highlight-image">
            <figure class="highlight-figure">
                <img src="../images/Villes/Edimbourg/royale_mile.jpg" alt="Royal Mile à Édimbourg">
                <figcaption>Le Royal Mile, artère historique reliant le Château au Palais.</figcaption>
            </figure>
        </div>
    </div>
    ...
    <div class="highlight-row">
        <div class="highlight-image">
            <figure class="highlight-figure">
                <img src="../images/Villes/Edimbourg/arthur_edim.jpg" alt="Arthur's Seat à Édimbourg">
                <figcaption>Vue depuis Arthur's Seat, le sommet volcanique de la ville.</figcaption>
            </figure>
        </div>
        <div class="highlight-text">
            <h3>Arthur’s Seat et les paysages naturels</h3>
            <p>
    Arthur’s Seat, vestige volcanique au cœur de Holyrood Park, domine Édimbourg de sa silhouette imposante. 
    Une randonnée accessible mène au sommet, où s’offre un panorama à 360° mêlant la ville historique, les collines verdoyantes, 
    les rives de la mer du Nord et les paysages sauvages de l’Écosse. Chaque pas sur ses sentiers évoque la puissance de la nature 
    et les légendes qui entourent cette colline emblématique.
</p>

            <p class="highlight-tip">
               <strong>Astuce :</strong> Prévoyez de bonnes chaussures de marche et vérifiez la météo. Le sommet peut être venteux, mais la vue en vaut la peine !
            </p>
        </div>
    </div>
</section>
