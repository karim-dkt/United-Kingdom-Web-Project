...
<br><br>
    ...
    <ul class="icon-list"> 
     ...
     <!-- HAUT : image à gauche, texte à droite -->
       <h1 style="text-align: center;">Musée britannique</h1><br>
    <section class="top-row">
      <div style="text-align: center;" class="top-image">
        <!-- Remplace "img1.jpg" par ton fichier -->
        <img src="../images/Monuments/musee/bmuseum0.jpg" alt="Image de présentation">
      </div>
    ...
    <section class="middle-text">
        ...
        <div class="top-text">
        <h2 style="text-align: center;">Un Voyage au Cœur des Civilisations</h2><br>
        <p>Situé au centre de Londres, le British Museum est l’un des musées les plus célèbres et les plus importants au monde. 
            Fondé au XVIIIᵉ siècle, il a pour mission de préserver, étudier et présenter l’histoire de l’humanité à travers les objets et les œuvres laissés par les civilisations passées. 
            Pour un projet de présentation du Royaume-Uni, ce musée représente un exemple majeur du rôle culturel et éducatif que le pays occupe à l’échelle internationale.
        </p>
        </div>

      <p>
        Le British Museum abrite une collection impressionnante provenant de tous les continents : antiquités égyptiennes, grecques, romaines, asiatiques, africaines et bien d’autres encore. 
        Parmi les pièces les plus célèbres, on trouve la Pierre de Rosette, les frises du Parthénon ou encore les momies égyptiennes. 
        Chaque galerie permet de découvrir une période ou une région du monde, offrant aux visiteurs un véritable voyage dans le temps et à travers les cultures.
      <p>
     Au-delà de la richesse de ses collections, le British Museum se distingue par son architecture remarquable. 
     Son bâtiment principal de style néoclassique et sa cour intérieure couverte, la Great Court, avec son toit en verre spectaculaire, créent un espace lumineux et moderne au cœur d’un musée historique. 
     Ce contraste entre ancien et contemporain reflète parfaitement la volonté du Royaume-Uni de valoriser son patrimoine tout en s’ouvrant à l’innovation.
      </p><br>
      <p>
       Aujourd’hui, le British Museum est bien plus qu’un simple lieu d’exposition : c’est un centre culturel majeur, un espace de réflexion sur l’histoire, la mémoire et le dialogue entre les civilisations. 
       Il attire chaque année des millions de visiteurs, confirmant son importance dans le paysage culturel britannique et international.
       </p>
        <p>
         Le musée joue également un rôle essentiel sur le plan éducatif et scientifique. 
         Il organise des expositions temporaires, des conférences, des ateliers et met à disposition de nombreux contenus numériques pour le grand public, les chercheurs et les étudiants.
          Son accès gratuit à la collection permanente en fait un lieu ouvert à tous, favorisant la diffusion du savoir et la découverte des cultures du monde.
        </p><br>
        <p>
           Grâce à sa réputation internationale, à la diversité de ses collections et à son accessibilité, le British Museum s’impose comme l’un des plus grands centres culturels au monde. 
           Il témoigne du lien profond entre le Royaume-Uni et la préservation du patrimoine mondial, offrant aux visiteurs un espace privilégié pour comprendre l’histoire de l’humanité et apprécier la richesse des civilisations qui ont façonné notre monde.
        </p>
    </section><br>
